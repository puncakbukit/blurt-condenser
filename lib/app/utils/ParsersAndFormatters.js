...
function formatDecimal(value) {
  ...
  var decSeparator, fl, i, j, sign, thouSeparator, abs_value;
...
function translateError(string) {
  ...
  switch (string) {
    case 'Account not found':
      return (0, _counterpart["default"])('g.account_not_found');
    case 'Incorrect Password':
      return (0, _counterpart["default"])('g.incorrect_password');
    case 'Username does not exist':
      return (0, _counterpart["default"])('g.username_does_not_exist');
    case 'Account name should be longer.':
      return (0, _counterpart["default"])('g.account_name_should_be_longer');
    case 'Account name should be shorter.':
      return (0, _counterpart["default"])('g.account_name_should_be_shorter');
    case 'Account name should start with a letter.':
      return (0, _counterpart["default"])('g.account_name_should_start_with_a_letter');
    case 'Account name should have only letters, digits, periods or dashes.':
      return (0, _counterpart["default"])('g.account_name_should_have_only_letters_digits_or_dashes');
    case 'Only one Blurt account allowed per IP address every 10 minutes':
      return (0, _counterpart["default"])('g.only_one_APP_NAME_account_allowed_per_ip_address_every_10_minutes');
    case 'Cannot increase reward of post within the last minute before payout':
      return (0, _counterpart["default"])('g.cannot_increase_reward_of_post_within_the_last_minute_before_payout');
    default:
      return string;
  }
}