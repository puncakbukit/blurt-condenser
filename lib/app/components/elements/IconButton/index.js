...
var IconButton = function IconButton(_ref) {
  var icon = _ref.icon,
    ...
    fill = _ref.fill;
  var icons = {
    pencil: /*#__PURE__*/_react["default"].createElement("path", {
      className: "icon-button icon-button__pencil icon-button--".concat(fill),
    ...
    magnifyingGlass: /*#__PURE__*/_react["default"].createElement("path", {
      className: "icon-button icon-button__magnifyingGlass icon-button--".concat(fill),
      d: "M14.3681591,18.5706017 L11.3928571,21.6 L14.3681591,18.5706017 C13.273867,17.6916019 12.5714286,16.3293241 12.5714286,14.8 C12.5714286,12.1490332 14.6820862,10 17.2857143,10 C19.8893424,10 22,12.1490332 22,14.8 C22,17.4509668 19.8893424,19.6 17.2857143,19.6 C16.1841009,19.6 15.1707389,19.215281 14.3681591,18.5706017 Z",
      id: "icon-svg"
    }),
    question: /*#__PURE__*/_react["default"].createElement("path", {
      className: "icon-button icon-button__magnifyingGlass icon-button--".concat(fill),
  ...
  var fillColor = "icon-button__svg--".concat(fill);
  return /*#__PURE__*/_react["default"].createElement("svg", {
    className: "icon-button__svg icon-button__svg--".concat(fill, " icon-button__svg--").concat(size),
    viewBox: viewBox,
    version: "1.1",
    xmlns: "http://www.w3.org/2000/svg"
  }, /*#__PURE__*/_react["default"].createElement("g", null, /*#__PURE__*/_react["default"].createElement("circle", {
    className: "icon-button icon-button__border icon-button__border--".concat(fill),
    cx: "16",
    cy: "16",
    r: "15"
  }), icons[icon]));
...
IconButton.propTypes = {
  icon: _propTypes["default"].oneOf(['pencil', 'magnifyingGlass', 'question']),
  size: _propTypes["default"].oneOf(['small', 'medium', 'large']),
  fill: _propTypes["default"].oneOf(['transparent', 'green'])
};
